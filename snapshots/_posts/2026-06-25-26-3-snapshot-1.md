...
| Downfall          | 0.6       |
| Grass Color       | <span class="color-preview" style="background-color: #DF6827"></span> `#DF6827` |
| Foliage Color     | <span class="color-preview" style="background-color: #E68E30"></span> `#E68E30` |
| Dry Foliage Color | <span class="color-preview" style="background-color: #8C3A04"></span> `#8C3A04` |
| Sky Color         | <span class="color-preview" style="background-color: #7CA3FF"></span> `#7CA3FF` |
| Fog Color         | <span class="color-preview" style="background-color: #CCD8E2"></span> `#CCD8E2` |
| Water Color       | <span class="color-preview" style="background-color: #375154"></span> `#375154` |
| Water Fog Color   | <span class="color-preview" style="background-color: #375154"></span> `#375154` |
...
| Blocks                                                                     | Map Color            |
| -------------------------------------------------------------------------- | -------------------- |
| Poplar Planks, Poplar Log (top), Stripped Poplar Log, Stripped Poplar Wood | <span class="color-preview" style="background-color: #999999"></span> `#999999` Light Gray |
| Poplar Log (side), Poplar Wood                                             | <span class="color-preview" style="background-color: #815631"></span> `#815631` Podzol     |
| Poplar Sapling                                                             | <span class="color-preview" style="background-color: #a7a7a7"></span> `#a7a7a7` Metal      |
| Poplar Leaves, Red Shrub, Shelf Mushroom                                   | <span class="color-preview" style="background-color: #007C00"></span> `#007C00` Plant      |
...
Thrown lingering potions that hit an entity now summon the effect cloud at the hit position, not the potion's current position, fixing [MC-276692](https://bugs.mojang.com/browse/MC-276692).

## Data Packs

### Data Components

TNT can no longer be primed in adventure mode (fix for [MC-222818](https://bugs.mojang.com/browse/MC-222818)) unless the priming item's `can_break` component allows breaking that TNT block.
