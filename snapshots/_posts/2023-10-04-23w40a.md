...
Shields now block attacks in the direction the player's **head** is facing, rather than the direction the player's **body** is facing, fixing {::bug:MC-109101}.
...
Mobs can no longer gain potion effects through splash potion or area of effect clouds while dead or dying, fixing {::bug:MC-114761}.
