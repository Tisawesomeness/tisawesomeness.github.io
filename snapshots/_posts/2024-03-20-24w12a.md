...
The heavy core still does not have an assigned tool, as {::bug:MC-269355} is not fixed. It takes **15 seconds** to mine regardless of tool used.

The `orientation` block state was removed, fixing {::bug:MC-269356}.

## The Mace

The mace now breaks cobwebs at normal speed, fixing {::bug:MC-269513}.
