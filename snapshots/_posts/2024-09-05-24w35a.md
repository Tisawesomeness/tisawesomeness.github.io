...
Salmon variants now have different hitboxes sizes, fixing {::bug:MC-275222}.
...
The way the game chooses where to spawn raiders has changed significantly. Some of these changes are meant to fix {::bug:MC-275279}.
