...
These changes fix {::bug:MC-279235}.
...
Leaf litter can be placed on top of any block whose top face includes the center 2x2 pixels, such as iron bars (same conditions as torches), fixing {::bug:MC-279207}.
