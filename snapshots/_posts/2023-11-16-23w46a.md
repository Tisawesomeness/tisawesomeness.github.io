...
The Crafter now has a 4 game tick delay between each craft, fixing {::bug:MC-265910}.

Copper bulbs now activate and deactivate instantly.

## Wind Charge

The wind charge's bounding box is shifted 0.15 blocks downwards from its position, fixing {::bug:MC-266459}.
...
The trial spawner was added to the `#features_cannot_replace` block tag, fixing {::bug:MC-266538}.
