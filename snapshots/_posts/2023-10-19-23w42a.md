...
Firework rockets can now break pointed dripstone, decorated pots, and chorus fruit (fixing {::bug:MC-223774}). Firework rockets were added to the `#impact_projectiles` entity type tag.
