...
**Mojang has patched update suppression.** Updates are no longer processed completely recursively, so no `StackOVerflowException` will be thrown.

The block update order has changed.
