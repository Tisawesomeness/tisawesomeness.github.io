...
The shrieker now has a warning level from 0 to 4 instead of 0 to 3 to accommodate the unused sound mentioned in {::bug:MC-249910}.
...
Players will only stay on a block while crouching if they are moving downwards or not moving vertically, fixing {::bug:MC-197647}.
