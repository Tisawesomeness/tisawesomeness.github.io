...
Crafting a suspicious stew with a torchflower (not currently possible due to a {::bug:bug:MC-260033}) gives **night vision** for 5 seconds.

# Horse Breeding

The horse breeding fomulas were changed to the proposed fix in the comments of {::bug:MC-16533}. See [this website](https://www.matthewgatland.com/horses_old_and_new.html) for an interactive comparison (thanks to [Matthew Gatland](https://www.matthewgatland.com/)).
...
Players can no longer be kicked for flying while dead or dying, fixing {::bug:MC-258580}.
