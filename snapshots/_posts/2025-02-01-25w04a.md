...
Player movement was **not** reverted to 1.21.4 behavior. Instead, the {::bug:MC-271065} and {::bug:MC-152728} bugs were manually re-added. Other movement-related bugs fixed in 25w02a are still patched.
...
The `provides_banner_patterns` component is **not** hash-prefixed, unlike what the changelog says. See {::bug:MC-279698}.
