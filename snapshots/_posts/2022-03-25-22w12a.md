...
Mangrove leaves can now be used as compost with a 30% chance to increase the composter by one level, fixes {::bug:MC-249303}.

Mangrove fences and fence gates give 300 ticks of fuel, fixes {::bug:MC-249316}. Mangrove boats give 1200 ticks of fuel, the same as other boats.

# Mud Bricks

The mud brick slab's hardness was changed to 1.5, and the blast resistance was changed to 3. Mud brick slabs now have the same properties as other mud brick blocks and fixes {::bug:MC-249312}.
...
Mojang confirmed that the update suppression fix last snapshot is {::bug:intended:MC-249082}. The update order change, however, was a bug and is now {::bug:fixed:MC-249181}.
