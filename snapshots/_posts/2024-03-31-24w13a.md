...
changelog: https://www.minecraft.net/en-us/article/minecraft-snapshot-24w13a
release: 1.20.5
stage: snapshot
---

A massive snapshot adding the final 1.21 features.
...
| Wind Burst  | 2      | 4 (item), 2 (book)                                                                                | No{::bug:\*:MC-269977} | Yes{::bug:\*:MC-270125} |
...
Higher levels of wind burst currently {::bug:crash the game:MC-270004}.

Unlike player-shot wind charges, explosions from the Wind Burst enchantment {::bug:do not reduce fall damage:MC-269985}.
...
Note that `spawn_item_after_ticks` currently {::bug:does not work:MC-269964}.
...
`body` is now a slot that can be used in attribute modifiers, fixing {::bug:MC-269143}.
