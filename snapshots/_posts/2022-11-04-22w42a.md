...
All bamboo blocks {::bug:except mosaic slabs:MC-256623} have the same flammability as overworld wood types.
...
Panorama scroll speed is bound from 0% to 100% even when edited in options.txt, though {::bug:saving panorama scroll speed currently doesn't work:MC-256476}.

{::bug:MC-112826} was fixed but not included in the changelog.
