...
Composters and jukeboxes now always spawn items 0.01 blocks above the block when ejected from them, fixing {::bug:MC-271941}.

## Technical Changes

Teleport commands now reset flying detection, fixing {::bug:MC-267364}.
