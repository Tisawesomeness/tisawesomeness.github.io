...
A nautilus moves at 0.0325 blocks/tick when ridden. Passengers ride the nautilus 1.1375 blocks above the nautilus' position.
...
| Cold Ocean          | 2/5    |
| Deep Cold Ocean     | 2/5    |
| Deep Frozen Ocean   | 2/3    |
| Deep Lukewarm Ocean | 1/5    |
| Deep Ocean          | 5/7    |
| Frozen Ocean        | 2/3    |
| Lukewarm Ocean      | 5/17   |
| Ocean               | 5/7    |
...
Mobs using a spear have a range of **1 to 2.25 blocks**. Unlike players, mobs do **not** expand target hitboxes to make it easier to hit targets. Mobs **cannot** use the Lunge enchantment.
...
Zombie jockeys spawn in the following biomes:
...
Standalone zombies now spawn less often in certain biomes to make room for zombie jockeys:
