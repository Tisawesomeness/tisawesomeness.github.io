...
The water world preset was changed to `minecraft:bedrock,64*minecraft:deepslate,5*minecraft:stone,5*minecraft:dirt,5*minecraft:gravel,90*minecraft:water;minecraft:deep_ocean` as suggested in the {::bug:bug report:MC-239708}
