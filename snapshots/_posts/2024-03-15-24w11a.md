...
changelog: https://www.minecraft.net/en-us/article/minecraft-snapshot-24w11a
release: 1.20.5
stage: snapshot
---

A new snapshot adds a new way to deal absurd damage.
...
When the Menu Background Blur setting is less than 10%, the blur shader is completely disabled, fixing {::bug:MC-269032}.
