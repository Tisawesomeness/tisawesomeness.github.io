...
Glow squids only spawn at light level 0 to fix {::bug:MC-238977}

Tropical fish will check if the block above is water before spawning to fix {::bug:MC-244683}
