...
Wind charges can no longer be hit or deflected for 5 ticks after spawning, fixing {::bug:MC-270377}.
...
Due to {::bug:MC-277234}, the game incorrectly converts `effect.minecraft.mining_fatigue` to `effect.minining_fatigue`. This is not reflected in the above files.
