...
Villagers can now pick up torchflower seeds and pitcher pods, fixing {::bug:MC-260810}.
...
Shovels are now the best tools for suspiciuos blocks, fixing {::bug:MC-261167}.
