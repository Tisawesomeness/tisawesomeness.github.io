...
No longer need to be facing players to shoot at them, fixing {::bug:MC-275538}.

## Mob Conversions

Some properties mentioned in {::bug:MC-88967} and not mentioned in the changelog are not transferred in any conversion:
...
The `explosion_power` tag is the base power (usually 4) of the explosion. The game adds a random bonus based on velocity to the base to get the final explosion power. This change fixes {::bug:MC-276263}.
