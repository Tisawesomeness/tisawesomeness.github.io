...
Attacking a Creaking emits an `entity_action` game event (sculk sensor frequency 4), fixing {::bug:MC-278659}.
...
If a player gliding with an elytra flies within range of a climbable block, they stop gliding, fixing {::bug:MC-90212}.
