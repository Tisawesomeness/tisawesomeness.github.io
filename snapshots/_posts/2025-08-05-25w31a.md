...
- Its position is less than 0.15 blocks to the block's center horizontally
- It is less than 0.2 blocks above the bottom of the air block, or its y-value is within `Y.00` (inclusive) and `Y.20` (exclusive)
...
Copper golem statues have **3 hardness** and **6 blast resistance**, like other copper blocks.
